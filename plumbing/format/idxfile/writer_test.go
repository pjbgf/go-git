...
// 		h, ok := plumbing.FromHex(o.hash)
// 		assert.True(t, ok)
// 		err = writer.OnInflatedObjectContent(h, o.offset, o.crc, nil)
// 		assert.NoError(t, err)
// 	}
...
// var (
// 	fixture4GbChecksum = x(plumbing.FromHex("afabc2269205cf85da1bf7e2fdff42f73810f29b"))
